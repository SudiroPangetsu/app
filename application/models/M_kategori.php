...
class M_kategori extends CI_Model
{
    ...
    {
        return $this->db->get_where('inventory', ['kluster' => 'k1'], $limit, $start)->result_array();
    }
    public function getData2($limit, $start)
    {
        return $this->db->get_where('inventory', ['kluster' => 'k2'], $limit, $start)->result_array();
    }
    public function getData3($limit, $start)
    {
        return $this->db->get_where('inventory', ['kluster' => 'k3'], $limit, $start)->result_array();
    }
    public function getData4($limit, $start)
    {
        return $this->db->get_where('inventory', ['kluster' => 'k4'], $limit, $start)->result_array();
    }
